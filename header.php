...
<head>
    <meta charset="utf-8">
    <title>OEL - Visa & Immigration Website </title>
...
<body>
    ...
    <div class="container-fluid bg-primary px-5 d-none d-lg-block">
        <div class="row gx-0 align-items-center">
            ...
            <div class="col-lg-3 row-cols-1 text-center mb-2 mb-lg-0">
                <div class="d-inline-flex align-items-center" style="height: 45px;">
                    ...
                    <a class="btn btn-sm btn-outline-light btn-square rounded-circle me-2"
                        href="https://www.facebook.com/profile.php?id=61587479755747"><i
                            class="fab fa-facebook-f fw-normal text-secondary"></i></a>
                    <a class="btn btn-sm btn-outline-light btn-square rounded-circle me-2"
                        href="https://www.linkedin.com/company/ekon-visa-services/"><i
                            class="fab fa-linkedin-in fw-normal text-secondary"></i></a>
                    <a class="btn btn-sm btn-outline-light btn-square rounded-circle me-2"
                        href="https://www.instagram.com/ekonvisaservices/"><i
            ...
            <div class="col-lg-4 text-center text-lg-end">
                <div class="d-inline-flex align-items-center" style="height: 45px;">
                    <a href="https://wa.me/919569672737?text=Hello%20I%20need%20help" class="text-muted me-2">
                        <i class="fab fa-whatsapp text-success"></i> Help
                    </a>
                    <small> / </small>
    ...
    <div class="container-fluid nav-bar p-0">
        <nav class="navbar navbar-expand-lg navbar-light bg-white px-4 px-lg-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse justify-content-center  ms-10" id="navbarCollapse">
